...
class MessageUtil:
  ...
  def addMessageToChannel(self, message, channel, identity = None):
    self._sendRequest(message, channel, identity, None)
    
  def addMessageToThread(self, message, channel, threadId, identity = None):
    self._sendRequest(message, channel, identity, threadId)
    
  def _sendRequest(self, message, channel, identity, threadId):
